document.addEventListener("DOMContentLoaded", function () {
    ...
    submitButton.addEventListener("click", function (event) {
        ...
        var form = document.forms["change-email-form"];
        ...
        xmlhttp.open("POST", "/server/change-email.php", true);
...
function printFormatError(form) {
    ...
    if (!prevError) {
        ...
        addText(formatError, "• The email format is invalid.");
...
function printAlreadyTakenError(form) {
    ...
    if (!prevError) {
        ...
        addText(alreadyTakenError, "• The email is already taken, sorry.");
        form.elements.email.style.borderColor = 'red';
